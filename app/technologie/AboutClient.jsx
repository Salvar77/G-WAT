        ...
        <div className={classes.about__container}>
          ...
          <div className={classes.about__content}>
            ...
            <ul className={classes.deviceList}>
              ...
              <li>
                <span className={classes.deviceText}>Sigenergy</span>
                <span className={classes.deviceIcon}>
                  <Image
                    src={icon8}
                    alt="Logo Sigenergy - innowacyjne systemy magazynowania energii"
                    width={32}
                    height={32}
                  />
                </span>
            ...
            <ul className={classes.certificatesList}>
              ...
              <li>
                ...
                <span className={classes.deviceIcon}>
                  <Image
                    src={icon8}
                    alt="Logo Sigenergy - zaawansowane magazyny energii"
                    width={32}
                    height={32}
                  />
                </span>
            ...
            <div className={classes.backupSection}>
              <h3>Zasilanie awaryjne (back-up)</h3>
              <p className={classes.backupIntro}>
                Specjalizujemy się w profesjonalnej instalacji trybu awaryjnego
                dla instalacji fotowoltaicznych.
              </p>

              <div className={classes.supportedInverters}>
                <h4>Obsługiwane falowniki:</h4>
                <p>
                  Deye • Solinteg • GoodWe • FoxEss • Solis • Solax •
                  FelicityEss (T-REX) • Sofar
                </p>
              </div>
              <br />
              <p className={classes.cennikInfo}>
                Szczegóły cennika znajdziesz w sekcji{" "}
